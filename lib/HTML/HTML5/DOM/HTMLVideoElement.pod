...
HTML::HTML5::DOM::HTMLVideoElement - implementation of the HTMLVideoElement interface of the HTML DOM

=head1 DESCRIPTION

HTML::HTML5::DOM::HTMLVideoElement is an implementation of the HTMLVideoElement interface of the HTML DOM. See L<HTML::HTML5::DOM> for a list of the conventions that have been used when translating the DOM to Perl.
...
=item * C<< {http://www.w3.org/1999/xhtml}video >>

=back

=head2 Inheritance

HTML::HTML5::DOM::HTMLVideoElement inherits methods from the following Perl classes.
...
Called with no arguments, is a shortcut for C<< $elem->getAttribute("poster") >> but as a blessed L<URI> object. Called with a defined argument, acts as C<setAttribute>. Called with undef as an argument, acts as C<removeAttribute>.
